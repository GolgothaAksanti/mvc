...
<body>
  ...
  <form action='' method="post" class="w-4/12 mt-20 mx-auto">
    <h1 class="text-2xl font-medium text-green-600">Login</h1>
  <div class="mb-6">
  ...
  <div class="mb-6">
    ...
    <input type="password" id="password"  placeholder="password" name="password"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
  </div>
  ...
  <div class="flex justify-between items-center">
    <input type="submit" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" value="Submit" name="LoginSubmit"/>
